...
- feat: detect db event processing lag
...
- fix version and filter political businesses in contest e-voting export
...
- CanditateMapping in ECH V5 for canton zh

## [v2.73.1] - 2025-12-16

### :arrows_counterclockwise: Changed

- CandidateMapping: set default values like TG for canton ZH
...
- limit reading of political business union to correct roles
...
- restrict blank row count to less than number of mandates

## [v2.72.1] - 2025-12-10

### :arrows_counterclockwise: Changed

- DomainOfInfluenceCantonDataTransformer: export party in candidate text only for canton sg
- Candidatemapping: moved logic for canton zh into function ToEchCandidateText()
...
- CandidateMapping in Ech/Mapping/V4 and V5: disabled candidateText for canton zh

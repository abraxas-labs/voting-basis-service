...
public class ContestEchExportsGenerator : ContestEchExportsGeneratorBase, IExportsGenerator
{
    ...
    public TemplateModel Template => BasisXmlContestTemplates.Ech0157And0159_5_1;

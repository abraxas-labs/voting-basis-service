...
public class MajorityElectionEchExportGenerator : MajorityElectionEchExportGeneratorBase, IExportGenerator
{
    ...
    public TemplateModel Template => BasisXmlMajorityElectionTemplates.Ech0157_5_1;

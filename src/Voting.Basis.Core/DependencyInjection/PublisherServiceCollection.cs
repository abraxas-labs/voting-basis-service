...
internal static class PublisherServiceCollection
{
    ...
    private static IServiceCollection AddWriterServices(this IServiceCollection services, PublisherConfig config)
    {
        return services
            ...
            .AddForwardRefScoped<PoliticalBusinessWriter, VoteWriter>()
            .AddForwardRefScoped<PoliticalBusinessWriter, ProportionalElectionWriter>()
            .AddForwardRefScoped<PoliticalBusinessWriter, MajorityElectionWriter>()
            .AddForwardRefScoped<PoliticalBusinessUnionWriter, ProportionalElectionUnionWriter>()

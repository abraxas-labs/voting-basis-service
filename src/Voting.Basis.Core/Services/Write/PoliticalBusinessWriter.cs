...
public abstract class PoliticalBusinessWriter
{
    ...
    protected PoliticalBusinessWriter(PoliticalBusinessEVotingApprovalInitializer politicalBusinessEVotingApprovalInitializer)
    {
    ...
    {
        await _politicalBusinessEVotingApprovalInitializer.Initialize([politicalBusiness]);
    }
}

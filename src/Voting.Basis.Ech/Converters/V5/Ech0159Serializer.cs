...
using Voting.Lib.Ech.Ech0159_5_1.Schemas;
...
public class Ech0159Serializer : IEch0159Serializer
{
    ...
    string IEch0159Serializer.EchVersion => "4_2";
    ...
    public Task<byte[]> ToEventInitialDelivery(Contest contest, IEnumerable<Vote> votes)
    {
        ...
        var voteTypes = votes
            ...
            .OrderBy(x => x.DoiType)
            .ThenBy(x => x.VoteInformation.Vote.DomainOfInfluence.DomainOfInfluenceIdentification)

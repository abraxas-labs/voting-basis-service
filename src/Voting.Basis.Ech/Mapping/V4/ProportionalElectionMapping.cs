...
internal static class ProportionalElectionMapping
{
    ...
    internal static EventInitialDeliveryElectionGroupBallot ToEchElectionGroup(this ProportionalElection proportionalElection, bool eVoting)
    {
    ...
    private static EventInitialDeliveryElectionGroupBallotElectionInformation ToEchElectionInformation(this ProportionalElection proportionalElection, bool eVoting)
    {

...
public class MajorityElectionBallotGroupUpdateTest : BaseGrpcTest<MajorityElectionService.MajorityElectionServiceClient>
{
    ...
    {
        await AssertStatus(
            async () => await AdminClient.UpdateBallotGroupAsync(NewValidRequest(pe =>
             {

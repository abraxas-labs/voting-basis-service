...
public class ProportionalElectionDeleteTest : PoliticalBusinessAuthorizationGrpcBaseTest<ProportionalElectionService.ProportionalElectionServiceClient>
{
    ...
    {
        await AssertStatus(
            async () => await CantonAdminClient.DeleteAsync(new DeleteProportionalElectionRequest
            {
                Id = IdNotFound,
            }),
            StatusCode.NotFound);
    ...
    {
        await CantonAdminClient.DeleteAsync(new DeleteProportionalElectionRequest
        {

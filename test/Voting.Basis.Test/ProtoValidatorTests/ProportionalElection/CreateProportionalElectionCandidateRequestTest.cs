...
public class CreateProportionalElectionCandidateRequestTest : ProtoValidatorBaseTest<CreateProportionalElectionCandidateRequest>
{
    protected override IEnumerable<CreateProportionalElectionCandidateRequest> OkMessages()
    {
    ...
    protected override IEnumerable<CreateProportionalElectionCandidateRequest> NotOkMessages()
    {

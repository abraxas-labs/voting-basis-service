...
public class CreateContestRequestTest : ProtoValidatorBaseTest<CreateContestRequest>
{
    protected override IEnumerable<CreateContestRequest> OkMessages()
    {
    ...
    protected override IEnumerable<CreateContestRequest> NotOkMessages()
    {
    ...
    private CreateContestRequest NewValidRequest(Action<CreateContestRequest>? action = null)
    {

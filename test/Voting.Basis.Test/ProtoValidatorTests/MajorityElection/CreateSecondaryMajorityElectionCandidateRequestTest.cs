...
public class CreateSecondaryMajorityElectionCandidateRequestTest : ProtoValidatorBaseTest<CreateSecondaryMajorityElectionCandidateRequest>
{
    protected override IEnumerable<CreateSecondaryMajorityElectionCandidateRequest> OkMessages()
    {
    ...
    private CreateSecondaryMajorityElectionCandidateRequest NewValidRequest(Action<CreateSecondaryMajorityElectionCandidateRequest>? action = null)
    {

...
public class CreateMajorityElectionCandidateRequestTest : ProtoValidatorBaseTest<CreateMajorityElectionCandidateRequest>
{
    protected override IEnumerable<CreateMajorityElectionCandidateRequest> OkMessages()
    {
    ...
    protected override IEnumerable<CreateMajorityElectionCandidateRequest> NotOkMessages()
    {
    ...
    private CreateMajorityElectionCandidateRequest NewValidRequest(Action<CreateMajorityElectionCandidateRequest>? action = null)
    {

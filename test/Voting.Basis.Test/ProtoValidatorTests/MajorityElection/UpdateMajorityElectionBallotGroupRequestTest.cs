...
public class UpdateMajorityElectionBallotGroupRequestTest : ProtoValidatorBaseTest<UpdateMajorityElectionBallotGroupRequest>
{
    protected override IEnumerable<UpdateMajorityElectionBallotGroupRequest> OkMessages()
    {
    ...
    protected override IEnumerable<UpdateMajorityElectionBallotGroupRequest> NotOkMessages()
    {
    ...
    private UpdateMajorityElectionBallotGroupRequest NewValidRequest(Action<UpdateMajorityElectionBallotGroupRequest>? action = null)
    {

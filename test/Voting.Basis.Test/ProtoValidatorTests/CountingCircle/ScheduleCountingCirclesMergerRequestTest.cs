...
public class ScheduleCountingCirclesMergerRequestTest : ProtoValidatorBaseTest<ScheduleCountingCirclesMergerRequest>
{
    protected override IEnumerable<ScheduleCountingCirclesMergerRequest> OkMessages()
    {
    ...
    protected override IEnumerable<ScheduleCountingCirclesMergerRequest> NotOkMessages()
    {
    ...
    private ScheduleCountingCirclesMergerRequest NewValidRequest(Action<ScheduleCountingCirclesMergerRequest>? action = null)
    {
